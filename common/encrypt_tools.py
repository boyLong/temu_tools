...
class Anti(object):
    def __init__(self, headers=None,cookie="", lt_c=None,gt_c=None, _=None ):

        self.headers = {}
        for key, value in headers.items():
            self.headers[key.lower()] = value

        self.lt_c = lt_c or [71, 97, 12, 171]
        self.gt_c = gt_c or [217, 54, 250, 195]
        self.anti_count = 1
        self._ = _ or [
            "?",
            "#",
        ...
        cookie = cookie or self.headers.get("cookie") or self.headers.get("Cookie")
    ...
    def get_anti(self, event=False, clientX=None, clientY=None, track=None, element=''):
        ...
        data = requests.post("http://127.0.0.1:8980/anti", json=data).json()
        self.anti_count += 1
        return data["data"]
...
class AsyncAnti(object):
    ...
    async def get_anti(self, event=False, clientX=None, clientY=None, track=None, element=''):
