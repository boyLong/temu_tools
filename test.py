...
#         "Connection": "keep-alive", "accept-language": "zh-CN,zh;q=0.9", "cache-control": "no-cache",
#         "content-type": "application/json;charset=UTF-8",
#         "referer": "https://www.temu.com/jiameng-pets-m-222447459331.html?_x_sessn_id=3z9kzzsc5e&refer_page_name=bgn_verification&refer_page_id=10005_1714312296323_ywgaj4p4bb&refer_page_sn=10005",
#         "pragma": "no-cache",
#         "sec-ch-ua": "\"Google Chrome\";v=\"123\", \"Not:A-Brand\";v=\"8\", \"Chromium\";v=\"123\"",
#         "sec-ch-ua-mobile": "?0", "sec-ch-ua-platform": "\"Windows\"", "sec-fetch-dest": "empty",
#         "sec-fetch-mode": "cors", "sec-fetch-site": "same-origin",
#         "verifyauthtoken": "JLmOfSrVB8xbNJUrtwonJg7b7bd49df06b6a587",
#         "Cookie": "timezone=Asia%2FShanghai; region=211; language=en; currency=USD; webp=1; _nano_fp=Xpman0XaX5Pbl0XbXo_bE40I6v9tpo1mYfpHJfD_; verifyAuthToken=JLmOfSrVB8xbNJUrtwonJg7b7bd49df06b6a587; api_uid=Cm14m2YuVGhBBQBTG3TRAg==; _bee=d5gChjKhPYKVfzGcAvamkEwpCe2jsapS; njrpl=d5gChjKhPYKVfzGcAvamkEwpCe2jsapS; dilx=lfRjGrjqVYwQJkG3QYk75; hfsc=L3yLfIox6z3405HFcQ==; _ttc=3.kVtk7CAtphzJ.1745848308"}
#
#
#
#
...
r = requests.post("http://127.0.0.1:30200/a4",json={
    "headers": {
        'accept': 'application/json, text/plain, */*',
        'accept-language': 'zh-CN,zh;q=0.9',
        'cache-control': 'no-cache',
