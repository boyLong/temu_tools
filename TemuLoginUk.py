...
class TemuBase:
    def __init__(
        ...
        self.__url = {
            ...
            "UK":{
                "gif": "https://eu.thtk.temu.com/c/th.gif"

            }
        }
        self.__server_time = {}
        self.location = "https://www.temu.com/uk"

    async def index(self, href="https://www.temu.com/uk/login.html?login_scene=8"):
    ...
    async def gif(self, event_list=None):
        ...
        if event_list is None:
            event_list = [
            {
                "page_url": "https://www.temu.com/uk/login.html?login_scene=8",
                "refer_url": "",
                "op": "pv",
                "event": "page_show",
            },
    ...
    async def server_time(self):
        ...
        server_time = await self.session.get("https://www.temu.com/uk/api/server/_stm")
    ...
    async def a4(self):
        ...
        a_list =[
            self.session.get("https://www.temu.com/uk/api/phantom/dm/wl/cg"),
            self.session.get("https://www.temu.com/uk/api/phantom/xg/pfb/a3"),
            self.session.get("https://www.temu.com/uk/api/phantom/xg/pfb/b")
        ]
        try:
        ...
        resp = await self.session.post("https://www.temu.com/uk/api/phantom/xg/pfb/a4", json=a4)
        await self.session.get( "https://www.temu.com/uk/api/phantom/xg/pfb/l1")
        await self.gif()
        await self.session.get('https://www.temu.com/uk/api/adx/cm/ttc?scene=1&type=0')
    ...
    async def register(self):
        url = "https://www.temu.com/uk/api/bg/sigerus/auth/login_name/is_registered"
        ...
        resp = await self.session.post(
            "https://www.temu.com/uk/api/bg/sigerus/auth/pub_key/request",
        ...
        resp = await self.session.post("https://www.temu.com/uk/api/bg/sigerus/auth/login?is_back=1",
                          anti={
                              "event":True,
    ...
    async def account_risk_test(self):
        ...
        await self.index(f"https://www.temu.com/uk/?refer_page_name=login&refer_page_id={self.page_id}&refer_page_sn=1"
                   f"0013&_x_sessn_id={self._session_id}")

        await self.session.post("https://www.temu.com/uk/api/jade/hobbiton/conversion/user_privacy_setting")
        # resp = await self.session.post("https://www.temu.com/api/bg-barbera-api/user/short/profile",json={})
        # print(resp.json())
        resp = await self.session.post("https://www.temu.com/uk/api/bg/bg-uranus-api/uranus_cart/merge",json={})
        print(resp.json())
        await self.a4()
        url = 'https://www.temu.com/uk/api/poppy/v1/opt_list?scene=opt_list_all'
