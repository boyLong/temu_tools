...
class Temu:
            ...
            if self.need_login:
                ...
                if res:
                    if self.detail:
                        ...
                        res = await self.check_detail(list_id, pageListId)
                        if not res:
    ...
    async def check_detail(self,list_id, pageListId):
    ...
    async def register(self):
        self.__location = ("https://www.temu.com/login.html?from=https%3A%2F%2Fwww.temu.com%2F&login_scene="
        ...
        logger.info(f'开始注册')
        await asyncio.gather(*[self.server_time(), self.gif(event_list=envent), self.gif([
            {
                "login_scene": "2",
                "page_el_sn": "200070",
                "op": "click",
